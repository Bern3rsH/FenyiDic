import { Boxes, Heart, Info, Pencil, Settings2, SquarePlus, Upload } from 'lucide-react'
    ...
    <div className="w-64 bg-gray-50 border-r border-gray-200 flex flex-col h-full flex-shrink-0">
      ...
      <div className="p-3 border-t border-gray-200">
        <div className="flex items-center gap-2">
          <button
            onClick={onImport}
            className="flex min-w-0 flex-1 items-center gap-2 rounded-lg px-3 py-2 text-sm text-gray-600 transition-colors hover:bg-gray-100"
          >
          ...
          <button
            ...
            className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-md bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700"
