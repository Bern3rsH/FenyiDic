...
export function ConfirmDialog({
  ...
  const iconByType = {
    ...
    warning: <TriangleAlert className="h-6 w-6 text-yellow-500" aria-hidden="true" />,
    danger: <CircleAlert className="h-6 w-6 text-red-500" aria-hidden="true" />,
    success: <CircleCheck className="h-6 w-6 text-green-500" aria-hidden="true" />
  }
